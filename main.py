...
def player_pts(data):
    sorted_data=sorted(key=lambda player: player["Pts"], reverse=True)#Sort ranks the points in ascending order but reverse puts it in descending.
...
def player_fgm(data):
    sorted_data=sorted(key=lambda player: player["FGM"], reverse=True)
...
def player_fga(data):
    sorted_data=sorted(key=lambda player: player["FGA"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_fta(data):
    sorted_data=sorted(key=lambda player: player["FTA"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_ftm(data):
    sorted_data=sorted(key=lambda player: player["FTM"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_reb(data):
    sorted_data=sorted(key=lambda player: player["REB"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_ast(data):
    sorted_data=sorted(key=lambda player: player["AST"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_stl(data):
    sorted_data=sorted(key=lambda player: player["STL"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_blk(data):
    sorted_data=sorted(key=lambda player: player["BLK"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_tov(data):
    sorted_data=sorted(key=lambda player: player["TOV"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_min(data):
    sorted_data=sorted(key=lambda player: player["MIN"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
def player_per2(data):
    sorted_data=sorted(key=lambda player: player["PER"], reverse=True)
    for rank, player in enumerate(data, start=1):
...
#Ask the user for choices
    print("")
    print("Enter 1 if you want to examine a specific player")
    ...
    while True:
        try:
            choice_one= int(input("Enter your choice (1-3): (type 0 to exit) "))
